...
import PartnershipPaymentModalContent from 'components/PartnershipPaymentModalContent';
...
const Membership = () => {
    ...
    const [formInputData, setFormInputData] = useState({
        ...
        password: '', passwordConfirm: '', maritalStatus: 'married', gender: 'male'
    });
    ...
    const checkEmailInUseStatus = (e) => {
         ...
         */
        (async () => {
            const rawResponse = await fetch('/api/auth/verify-member-email', {
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
                ...
                <div className="flex justify-center min-h-screen">
                    ...
                    <div className="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
                        <div className="w-full">
                            ...
                            <div className="md:flex md:flex-row flex-col justify-around md:my-4">
                                <div className="mt-2">
                                    <h1 className="text-gray-300">Gender</h1>

                                    <div className="mt-3 md:flex md:items-center">
                                        <div>
                                            <input onChange={handleFormInput} name="gender" type="radio" id="male" value="male" className="peer hidden" defaultChecked />
                                            <label
                                                htmlFor="male"
                                        ...
                                        <div>
                                            <input onChange={handleFormInput} name="gender" type="radio" id="female" value="female" className="peer hidden" />
                                            <label
                                                htmlFor="female"
                                                className="text-white block cursor-pointer select-none rounded-xl p-2 text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white">
                                                Female
            ...
            <div data-modal-show="true" aria-hidden="true" className={`${isMakingPayment ? 'flex' : 'hidden'} modal bg-overlay flex flex-col justify-start items-center fixed z-50 h-full w-full inset-0 visible opacity-100 transition-all-300 overflow-auto`}>
                <div className="flex justify-center my-10 w-full">
                    <div className="scale-100 w-[1000px] min-w-[250px] bg-gray-200 rounded-lg px-3 pb-3 pt-7 mx-3 md:m-5 relative">
                        ...
                        <PartnershipPaymentModalContent />
                    </div>
                </div>
            </div>
            {
