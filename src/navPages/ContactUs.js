                                            ...
                                            <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                                <div className="flex items-start">
                                                    ...
                                                    <div className="grow ml-6">
                                                        <p className="font-bold mb-1">Prayer Line</p>
                                                        <p className="text-gray-500">+2348133030917</p>
                                                        <p className="text-gray-500">+2349066280263</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                                <div className="flex items-start">
                                                    ...
                                                    <div className="grow ml-6">
                                                        <p className="font-bold mb-1">Partnership Line</p>
                                                        <p className="text-gray-500">+2347043315405</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
