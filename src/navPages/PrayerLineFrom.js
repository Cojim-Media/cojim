...
const PrayerLineFrom = () => {
    ...
    const [uploadedFullPhotographImg, setUploadedFullPhotographImg] = useState();
    const [fullPhotographReaderResult, setFullPhotographReaderResult] = useState();
    ...
    const handlefullPhotographUpload = (e) => {
        setUploadedFullPhotographImg(e.target.files[0]);
    }
    ...
    const handleSubmit = (e) => {
        ...
        if (!uploadedFullPhotographImg) {
            setSubmitted(false);
            Swal.fire({
                title: 'Error!',
                text: 'Please upload a photograph of your condition to continue',
                icon: 'error',
                confirmButtonText: 'Ok'
            });
            return false;
        ...
        (async () => {
            const rawResponse = await fetch('/api/prayer-line/submit-request', {
                ...
                body: JSON.stringify({
                    ...
                    fullPhotograph: fullPhotographReaderResult
                })
            });
    ...
    useEffect(() => {
        ...
        const fullPhotographReader = new FileReader();
        fullPhotographReader.readAsDataURL(uploadedFullPhotographImg);
        fullPhotographReader.onloadend = () => {
            setFullPhotographReaderResult(fullPhotographReader.result);
        };
        fullPhotographReader.onerror = () => {
            Swal.fire({
                title: 'Error!',
                text: 'Something went wrong with the uploaded full photograph',
                icon: 'error',
                confirmButtonText: 'Ok'
            });
        };
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [uploadedFullPhotographImg]);
                ...
                <div className="px-8 py-6 mx-4 mt-4 text-left bg-white shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3">
                    ...
                    <div>
                        ...
                        <div className="flex -mx-3">
                            ...
                            <div className="w-1/2 px-3 mb-5">
                                <label for="" className="text-xs font-semibold px-1">Country of Residence</label>
                                <div className="flex">
                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                            ...
                            (prayerType === 'healing') ?
                                <>
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-5">
                                            <label for="" className="text-xs font-semibold px-1">
                                                Medical aid instruments e.g Lumber Corset,
                                                Neck Colar, Inhealer, Wheelchair, Pair of Clutches,
                                                Nebulizer etc.
                                            </label>
                                            <div className="flex">
                                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                    ...
                                    <label for="" className="text-xs font-semibold px-1">
                                        NOTE: THE ABOVE INFORMATION MUST BE CAPTURED IN SHORT CLIP VIDEO AND SENT
                                    ...
                                    <label for="" className="text-xs text-red-600 font-semibold px-1">
                                                    This clip will be used on our social media handles/TV stations 
                                                    on the purpose of evanglism to bring souls to the kingdom of God
                                    </label>
                                </> :
                                (prayerType === 'deliverance') ?
                                    <>
                                        <label for="" className="text-xs font-semibold px-1">
                                            IF YOU HAVE SPIRITUAL PROBLEMS RANGING FROM DEMONIC OPERATION, NIGHT MARES,
                                            EVIL ATTACKS, MOVING OBJECTS, MARITAL PROBLEMS LIKE DISAPPOINTMENTS IN MARRIAGE,
                                            FAILURE, GENERATIONAL CURSES  LIKE POVERTY, SUDDEN DEATH FROM THE FAMILY, ETC.
                                        </label>
                                    </> : ''
                        }
                        ...
                        <div className="flex mt-2 -mx-3">
                            <div className="w-full px-3 mb-5">
                                <label for="" className="text-xs font-semibold px-1">
                                    kindly state how long you have been having the problem or problems
                                </label>
                                <div className="flex">
                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                        ...
                        <div className="flex -mx-3">
                            <div className="w-full px-3 mb-5">
                                <label for="" className="text-xs font-semibold px-1">
                                    A photograph of yourself in your current condition
                                </label>
                                <div className="flex">
                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                    <div
                                        ...
                                        <label className="cursor-pointer hover:opacity-80 inline-flex items-center shadow-md my-2 px-2 py-2 bg-gray-900 text-gray-50 border border-transparent
                                                rounded-md font-semibold text-xs tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none 
                                                focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150" htmlFor="fullPhotograph">

                                            Upload a photograph of your self in your current condition
                                        </label>
                                        <input id="fullPhotograph" onChange={handlefullPhotographUpload} className="text-sm cursor-pointer w-36 hidden" type="file" />
                                    ...
                                    <div
                                        ...
                                        {
                                            uploadedFullPhotographImg ?
                                                <img className="w-16 h-24 md:w-32 md:h-40" src={URL.createObjectURL(uploadedFullPhotographImg)} alt="Uploaded full photograph" /> :
                                                <span className="text-gray-400 opacity-75">
                                                    <svg className="w-14 h-14" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="0.7" stroke="currentColor">
                                                        <path strokeLinecap="round" strokeLinejoin="round"
                                                            d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
