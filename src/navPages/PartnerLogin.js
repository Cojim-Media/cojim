...
const PartnerLogin = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (email === '' || password === '') {
            ...
            (async () => {
                const rawResponse = await fetch('/api/auth/partner/login', {
                    method: 'POST',
                    headers: {
                    ...
                    <div className="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
                        <div className="flex-1">
                            ...
                            <div className="mt-8">
                                ...
                                <p className="mt-6 text-sm text-center text-gray-400">Don&#x27;t have an account yet? <a href="/partnership" className="text-blue-500 focus:outline-none focus:underline hover:underline">Become a partner</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
