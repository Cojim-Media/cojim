...
const PrayerLineDetails = ({ toggleEditModal, itemDetails, isEditModalOpen }) => {
    ...
    const handleApprove = (e) => {
        ...
        (async () => {
            const rawResponse = await fetch('/api/prayer-line/mark-as-reviewed', {
                method: 'PATCH',
                headers: {
                ...
                body: JSON.stringify({
                    prayerRequestId: itemDetails._id,
                })
            });
                                ...
                                <div className="px-6">
                                    <div className="bg-white p-3 shadow-xl rounded-sm">
                                        <div className="flex items-center space-x-2 font-semibold text-gray-900 leading-8">
                                            ...
                                            <span className="tracking-wide text-primary font-bold text-xl">Details</span>
                                        </div>
                                        <div className="text-gray-700">
                                            <div className="grid md:grid-cols-2 text-sm">
                                                <div className="grid grid-cols-2">
                                                    <div className="px-4 py-2 font-semibold">Full Name</div>
                                                    <div className="px-4 py-2">{itemDetails.fullname}</div>
                                                </div>
                                                <div className="grid grid-cols-2">
                                                    <div className="px-4 py-2 font-semibold">Prayer Type</div>
                                                    <div className="px-4 py-2 text-primary">{itemDetails.prayerType ? itemDetails.prayerType.toUpperCase() : ''}</div>
                                                </div>
                                                <div className="grid grid-cols-2">
                                                    <div className="px-4 py-2 font-semibold">Age</div>
                                                    <div className="px-4 py-2">{itemDetails.age}</div>
                                                </div>
                                                <div className="grid grid-cols-2">
                                                ...
                                                <div className="grid grid-cols-2">
                                                    <div className="px-4 py-2 font-semibold">State/Region/Province</div>
                                                    <div className="px-4 py-2">{itemDetails.state}</div>
                                                </div>
                                                <div className="grid grid-cols-2">
                                                    <div className="px-4 py-2 font-semibold">Having this problem since</div>
                                                    <div className="px-4 py-2">{itemDetails.problemDuration}</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center space-x-2 font-semibold text-gray-900 leading-8 mt-8">
                                            ...
                                            <span className="tracking-wide text-primary font-bold text-xl">Uploaded Records</span>
                                        </div>

                                        <div className="flex flex-wrap justify-center">
                                            <div className="w-full flex justify-center">
                                                <div className="relative">
                                                    <img alt="full photograph" className="mt-2" src={`${itemDetails.fullPhotograph ? itemDetails.fullPhotograph.url : ''}`} />
                                                </div>
                                            </div>
                                        </div>

                                        {
                                            (itemDetails.prayerType === "healing") ?
                                                <>
                                                    <div className="flex flex-wrap justify-center">
                                                        <div className="w-full flex justify-center">
                                                            <div className="relative">
                                                                <img alt="receipt" className="mt-2" src={`${itemDetails.medicalReport ? itemDetails.medicalReport.url : ''}`} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex flex-wrap justify-center">
                                                        <div className="w-full flex justify-center">
                                                            <div className="relative">
                                                                <img alt="receipt" className="mt-2" src={`${itemDetails.HIVTest ? itemDetails.HIVTest.url : ''}`} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </> : ''
...
export default PrayerLineDetails;