                        ...
                        <div className="flex flex-wrap items-center">
                            ...
                            <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
                                <div className="grow-0 shrink-0 basis-auto m-4 mb-6 md:mb-0 w-full px-3 lg:px-6">
                                    ...
                                    <div class="grow-0 shrink-0 basis-auto mt-4 w-full">
                                        <div class="flex flex-wrap">
                                            <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                                <div class="flex items-start">
                                                    ...
                                                    <div class="grow ml-6">
                                                        <p class="font-bold mb-1">Prayer Line</p>
                                                        <p class="text-gray-500">+2348133030917</p>
                                                        <p class="text-gray-500">+2349066280263</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                                <div class="flex items-start">
                                                    ...
                                                    <div class="grow ml-6">
                                                        <p class="font-bold mb-1">Partnership Line</p>
                                                        <p class="text-gray-500">+2347043315405</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                                <div class="flex align-start">
                                                    ...
                                                    <div class="grow ml-6">
                                                        <p class="font-bold mb-1">Visit Line</p>
                                                        <p class="text-gray-500">+2347037278975</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                                <div class="flex align-start">
                                                    ...
                                                    <div class="grow ml-6">
                                                        <p class="font-bold mb-1">Testimony Line</p>
                                                        <p class="text-gray-500">+2348159602829</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
