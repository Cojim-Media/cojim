...
const PartnerPaymentList = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      const rawResponse = await fetch(`/api/payment/get-payment-list/${partnerId}`, {
        method: 'GET',
      });
  ...
  return (
    <div className="w-full overflow-x-auto">
      ...
      </table>
      {
        (Object.values(payments) === undefined || Object.values(payments).length === 0) ? (
          <>
            <h3 className="text-center text-gray-600 p-4 text-lg">The list of all donations will appear here</h3>
            <div className="flex">
...
export default PartnerPaymentList