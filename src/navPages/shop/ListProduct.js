    ...
    return (
        <div className="w-full overflow-x-auto">
                                ...
                                Object.values(products).map((product, index) => {
                                    return (
                                        <tr key={index} className="border-b border-gray-200 hover:bg-gray-100">
                                            ...
                                            <td className="py-3 px-6 text-left">
                                                <span>{(product.category) ? product.category.toUpperCase() : '[Deleted]'}</span>
                                            </td>
                                            ...
                                            <td className="py-3 px-6 text-center">
                                                <span>USD {product.sellingPrice}</span>
                                            </td>
                                            <td className="py-3 px-6 text-center">
                                                {
                                                    (product.quantity <= 0) ? (
            ...
            </table>
            {
                (Object.values(products) === undefined || Object.values(products).length === 0) ? (
                    <>
                        <h3 className="text-center text-gray-600 p-4 text-lg">Your products will appear here</h3>
                        <div className="flex">
