...
const PartnershipPaymentModalContent = () => {
  // For the paystack
        ...
        <div className="">
          ...
          {filter === 'BANK' && (
            <div className="inter-left">
              ...
              <p>All member must send proof of payment to the following;</p>
              ...
              <p className="note">
                Please state the purpose of your payment on the payment slip or
...
export default PartnershipPaymentModalContent